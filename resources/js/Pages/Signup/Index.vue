                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center px-4 py-2.5 border border-gray-300 rounded-lg focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/20 transition-all duration-200 hover:border-gray-400">
                            ...
                            <input type="text" id="name" placeholder="Your full name" class="ml-3 bg-transparent text-gray-900 placeholder-gray-400 outline-none text-sm w-full" required>                 
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center px-4 py-2.5 border border-gray-300 rounded-lg focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/20 transition-all duration-200 hover:border-gray-400">
                            ...
                            <input type="password" id="password" placeholder="Create a password" class="ml-3 bg-transparent text-gray-900 placeholder-gray-400 outline-none text-sm w-full" required>                 
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center px-4 py-2.5 border border-gray-300 rounded-lg focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/20 transition-all duration-200 hover:border-gray-400">
                            ...
                            <input type="password" id="password-confirm" placeholder="Confirm your password" class="ml-3 bg-transparent text-gray-900 placeholder-gray-400 outline-none text-sm w-full" required>                 
                        </div>
                    </div>
